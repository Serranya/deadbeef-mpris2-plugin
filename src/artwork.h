...
typedef struct {
	...
	char* (*get_album_art)(const char *fname, const char *artist, const char *album, int size,
	...
	// creates full path string for cache storage
	int (*make_cache_path2)(char *path, int size, const char *fname, const char *album, const char *artist,
	                        int img_size);
} DB_artwork_plugin_t;
